    ...
    <div className='space-y-3'>
      ...
      <div className='flex gap-8'>
        <div className='relative isolate h-72 flex-1 overflow-hidden'>
          <div className='from-background/0 to-background pointer-events-none absolute right-0 bottom-0 left-0 z-50 h-24 bg-gradient-to-b to-90%'></div>
          <div>
            {threeArray.map((i) => {
        ...
        <div className='flex-1 space-y-4 pb-6'>
          <div className='flex gap-2'>
            {NOTABLE_PROJECTS.map((_, i) => (
              <button className='relative -mt-4 size-full py-4'>
