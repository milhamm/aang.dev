  ...
  return (
    <>
      ...
      <Collapsible.Root asChild>
        <span>
          <Collapsible.Trigger className='reveal-trigger border-foreground hover:text-background focus:text-background cursor-help rounded-xl border px-1 hover:border-[var(--motion-accent)] hover:bg-[var(--motion-accent)] focus:border-[var(--motion-accent)] focus:bg-[var(--motion-accent)] md:text-base xl:px-3 xl:text-2xl'>
            {triggerName}
          </Collapsible.Trigger>
