...
# Animation must have a <span className='from-yellow-400 to-yellow-500 dark:from-yellow-300 dark:to-yellow-400 bg-gradient-to-r bg-clip-text text-transparent'> meaning </span> to feel right
